...
?>
			...
			<tr>
				...
				<td>
					<img width="80px" src="public/upload/image/<?php echo $row->options->image ?>">
				</td>
				...
				<td>
					<a href="xoagiohang/<?php echo $row->rowId ?>">
						<img width="20px" src="public/pages/image/delete_icon_16.png"">
					</a>
				</td>
				<td>
					<a class="updateCart" rowId="<?php echo $row->rowId ?>" href="javascript:void(0)">
						<img width="25px" src="public/pages/image/update.png">
					</a>
				</td>
			</tr>
			<?php } ?>
