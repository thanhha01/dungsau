	...
	<div class="breadcrumb_wrap">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li>
					<a href="{{ url(''.$cate_name->cates_lv1->cates->id.'-'.$cate_name->cates_lv1->cates->alias.'.html') }}">{{$cate_name->cates_lv1->cates->name}}</a>
				</li>
				<li>
					<a href="{{ url('danh-muc-'.$cate_name->cates_lv1->alias.'/'.$cate_name->cates_lv1->id.'-'.$cate_name->cates_lv1->alias.'.html') }}">{{$cate_name->cates_lv1->name}}</a>
				</li>
				<li>
